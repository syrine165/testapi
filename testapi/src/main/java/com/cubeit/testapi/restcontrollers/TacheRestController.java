...
public class TacheRestController {
    ...
    public String deleteTacheById(@PathVariable("id")String id){
     ...
     //API findAll taches By Titre
     @GetMapping("/all/bytitre/{titre}")
     @ResponseBody
     public List<Tache> getTachesByTitre(@PathVariable("titre") String titre){
 
         List<Tache> taches=tacheService.findByFullTitre(titre);
